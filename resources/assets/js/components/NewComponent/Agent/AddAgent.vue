 ...
 <template>
  <div>
    <div class="card shadow-bl">
      <div class="card-header wh ldeep fs18">Agent List
    ...
    >
      <b-form @submit="storeData()">
        <div class="modal-header lblue wh">
          <h5 class="modal-title" v-if="updated && !view" id="exampleModalCenterTitle">Edit Agent</h5>
          <h5
            class="modal-title"
            v-else-if="!updated && !view"
            id="exampleModalCenterTitle"
          >Add Agent</h5>
          <h5 class="modal-title" v-else id="exampleModalCenterTitle">Agent</h5>
        ...
        <div class="container">
          <div class="row">
            <div class="col-12">
              <h2 class="lsea round pd-10 mrt-20 wh fs20 hg40 wd-full">Agent Information</h2>
            </div>
...
export default {
  ...
  methods: {
    ...
    destroyData: async function(value) {
      swal({
        title: "Are you sure?",
        text: "You won't be delete your Agent?",
        type: "warning",
