    ...
    <div>
        <div class="card shadow-bl  ">
            ...
            <div class="container pd-20">
                ...
                <div class="mrl-20">
                    <h4 class="fs18"><b>Company ID :</b>&nbsp; {{data.company_id}}</h4>
                    <h4 class="fs18"><b>Business Type :</b>&nbsp; {{data.business_type}}</h4>
                    <h4 class="fs18"><b>Establish :</b>&nbsp; {{data.establish}}</h4>
                    <!---<h4 class="fs18"><b>Currency :</b>&nbsp; Dolla </h4> ---->  
                    <hr>
                    <center><button class="btn round lsea" @click="onUpdateModal(data)"><span class="mdi mdi-grease-pencil"></span>&nbsp;Update Your Company</button></center>
                </div>
            </div>
        </div>
        ...
        <div class="container pd-10"> 
            <div class="container">
             <center> 
                    ...
                    <img style="width:50%!important; height:auto;"  class="full-width hg150" :src="form.img_company" alt=""> 
                </center>
            </div>
             <image-uploader v-if="!readonly" :preview=false :maxWidth="512" :quality="0.7" v-model="form.img_company"></image-uploader><br><br>
           ...
           <Input label="Business Type" cover="cover"  v-model="form.business_type" :def="form.business_type" />
           <Input label="Establish" :date="true" cover="cover"  v-model="form.establish" :def="form.establish"/>
           <hr>
            <center><button class="btn round lsea" @click="updateData()"><span class="mdi mdi-grease-pencil"></span>&nbsp;Update Your Company</button></center>
...
<script>
 import Input from "../../MbsComponent/Input";
    ...
    export default {
        ...
        /*-------------------------Load Component---------------------------------------*/
        components: {
            Input,Area,Timezone,ImageUploader
        },
        /*-------------------------Set Component---------------------------------------*/
        props: {
