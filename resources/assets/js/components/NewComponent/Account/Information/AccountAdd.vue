    ...
    <div>
        <div class="card shadow-bl ">
            ...
            <div class="container "><br>
                ...
                <AccountList ref="lists" :dataIn="dataIn"   @change="onUpdateModal" @view="read" @destroy="destroyData" />
        ...
        <modal name="add-account" style="overflow-y: auto;" height="auto" adaptive draggable :clickToClose="false">
    ...
    export default {
        ...
        methods: {
            ...
            destroyData: async function (value) {
                ...
                swal({
                    title: 'Are you sure?',
                    text: "You won't be delete your account?",
                    type: 'warning',
