    ...
    <div> 
        ...
        <div class="table-responsive">
            <table class="table ">
                <thead class="lblue">
                    <tr>
                        <th class="wh pointer" @click="changeSort('username')" scope="col">Username <span :class="arrow('username')"></span></th>
                        <th class="wh pointer" @click="changeSort('fullname')" scope="col">Fullname <span :class="arrow('fullname')"></span></th>
                        <th class="wh pointer" @click="changeSort('name')" scope="col">Branch Name <span :class="arrow('name')"></span></th>
                        <th class="wh pointer" @click="changeSort('email')" scope="col">Email <span :class="arrow('email')"></span></th>
                        <th class="wh pointer" @click="changeSort('users.phone')" scope="col">Phone <span :class="arrow('users.phone')"></span></th>
